...
# Maak twee tabbladen
tab1, tab2 = st.tabs(["Vliegtuigfabrikanten", "Marijn"])
...
with tab1:
    ...
    # Rest van de code voor Tabblad 1
...
with tab2:
    ...
    @st.cache_data
    def fetch_data():
        url = 'https://sensornet.nl/dataserver3/event/collection/nina_events/stream?conditions%5B0%5D%5B%5D=time&conditions%5B0%5D%5B%5D=%3E%3D&conditions%5B1%5D%5B%5D=time&conditions%5B1%5D%5B%5D=<...>'
        try:
    ...
    # Rest van de code voor Tabblad 2
